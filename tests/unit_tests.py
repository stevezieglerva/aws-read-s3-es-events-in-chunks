...
class TestMethods(unittest.TestCase):
	def test_format_for_es_bulk__valid_input_files__format_is_correct(self):
		...
		# Assert
		self.assertTrue("{ \"index\" : { \"_index\" : \"aws_lambda_logs\", \"_type\" : \"doc\", \"_id\" : \"4849393-4930093-40403-3\"} }" in result)
